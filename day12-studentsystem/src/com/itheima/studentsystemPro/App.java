...
public class App {
    ...
    static {
        //添加一些用户信息
        list.add(new User("zhangsan", "123456", "360732200001011234", "18112345678"));
    }
    ...
    private static void login(ArrayList<User> list) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            while (true) {
                ...
                System.out.println("当前正确的验证码位：" + rightCode);
            ...
            if (result) {
                ...
                if (i == 2) {
                    System.out.println("当前账号" + username + "被锁定，请联系xx客服：xxx_xxxxxx");
                    //当前账号锁定之后，直接结束方法即可
                    return;
                } else {
    ...
    private static void register(ArrayList<User> list) {
        ...
        User useInfo = new User(username, password, personID, phoneNumber);
        //把用户信息添加到集合中
        list.add(useInfo);
    ...
    private static boolean checkUsername(String username) {
        ...
        // 循环得到username里面的每一个字符，如果有一个字符不是字母或数字，那么就返回false
